...
base_lr = 0.001
custom_hooks = [
    dict(num_last_epochs=5, priority=48, type='YOLOXModeSwitchHook'),
...
data_root = 'data/exports/task_1_coco'
...
param_scheduler = [
    ...
    dict(begin=45, by_epoch=True, end=50, factor=1, type='ConstantLR'),
]
resume = False
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        '/home/bessho/github/mmplatform/data/exports/task_1_2026_0514_0128',
        metainfo=dict(classes=('person', )),
        pipeline=[
...
test_evaluator = dict(
    ann_file=
    '/home/bessho/github/mmplatform/data/exports/task_1_2026_0514_0128/annotations/instances_Validation.json',
    backend_args=None,
    metric='bbox',
    type='CocoMetric')
test_pipeline = [
...
train_ann = 'annotations/instances_Validation.json'
...
train_dataset = dict(
    ...
    type='MultiImageMixDataset')
train_img_prefix = 'images/Validation/'
train_pipeline = [
    dict(img_scale=(
        640,
        640,
...
val_ann = 'annotations/instances_Validation.json'
...
work_dir = '/home/bessho/github/mmplatform/work_dirs/web_train_2026_0515_0011_3857fe45'
